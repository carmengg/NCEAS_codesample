...
mex_rgb <- raster::stack(here('R/mexico_median_rgb.tif')) 
#mex_rgb
...
```{r}
# --- read shapefile
mex_sf <- read_sf(here('R/stanford-zc863pb5331-shapefile/zc863pb5331.shp')) %>%
...
```{r}
# --- read nir raster
nir <- raster(here('R/mexico_median_nir.tif')) 
